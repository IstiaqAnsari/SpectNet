...
if __name__ == '__main__':
    try:
        ...
        if(evaluate):
            ...
            print("Training")
            print("Training")
            load_path = '../../Adversarial Heart Sound Results/models/bcdefghi_a 2019-10-16 12:45:03.236037/weights.0036-0.5964.hdf5'
            model = heartnet(load_path,activation_function, bn_momentum, bias, dropout_rate, dropout_rate_dense,
                             eps, kernel_size, l2_reg, l2_reg_dense, lr, lr_decay, maxnorm,
            ...
            class hpRateScheduler(Callback):
                ...
                def on_epoch_begin(self, epoch,logs=None):
                    ...
                    try:
                        ...
                        print("hpRateScheduler - on_epoch_begin  - GRL not added")
