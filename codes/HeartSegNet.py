...
def heartnet2(load_path,activation_function='relu', bn_momentum=0.99, bias=False, dropout_rate=0.5, dropout_rate_dense=0.0,
...
def heartnet(load_path,activation_function='relu', bn_momentum=0.99, bias=False, dropout_rate=0.5, dropout_rate_dense=0.0,
    ...
    if(segments=='0101'):
        merged = Concatenate(axis=-1)([t2,t4])
    elif(segments=='1010'):
        merged = Concatenate(axis=-1)([t1, t3])
    else:
